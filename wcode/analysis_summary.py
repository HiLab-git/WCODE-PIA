...
if __name__ == "__main__":
    file_path_lst = ["./Logs/LNQ2023/MPNN/alpha_0.99_K_5_M_4_consist_weight_0.1_consist_rampup_100_consist_epoch_50_num_linknets_epochs_300_improved_weight_2.0_implement_type_improved/fold_0/test_best/summary.json"]
